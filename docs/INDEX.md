...
**Admin / Super Admin UI:** [`app/admin/`](../EHB%20landing-2026/app/admin/) hub and agent surfaces (`app/admin/agents/`, [`AgentControlClient.tsx`](../EHB%20landing-2026/components/admin/AgentControlClient.tsx), [`AgentRuntimeActionsClient.tsx`](../EHB%20landing-2026/components/admin/AgentRuntimeActionsClient.tsx)) follow the same P1 text tokens as the rest of the landing app (`text-white`, `text-ehb-textBody`, `text-ehb-textMuted`; see [FLOW-P1-foundation-ui.md](flows/FLOW-P1-foundation-ui.md), [TRACEABILITY_MATRIX.md](flows/TRACEABILITY_MATRIX.md)).

**P1 text-token rollout (routes):** [`app/`](../EHB%20landing-2026/app/) pages and layouts (`page.tsx`, `layout.tsx`, nested routes) use the same token map as [`components/`](../EHB%20landing-2026/components/); gradient CTAs keep `text-slate-950`, light fills (e.g. amber/emerald chips) keep `text-slate-900` where contrast requires it. **Data-driven class strings:** [`lib/agents/catalog.ts`](../EHB%20landing-2026/lib/agents/catalog.ts) (runtime badges), [`lib/content/homepage.ts`](../EHB%20landing-2026/lib/content/homepage.ts) (home `toneClass`), [`lib/industry/verificationStandards.ts`](../EHB%20landing-2026/lib/industry/verificationStandards.ts) (badges) — [FLOW-P1-foundation-ui.md](flows/FLOW-P1-foundation-ui.md). The [`modules/`](../EHB%20landing-2026/modules/) tree had no `text-slate-*` text utilities at last check (add tokens there if new string maps land). **OLS law reference** ([`ols-law-source/nextjs-app/`](../EHB%20landing-2026/content/industries/law/ols-law-source/nextjs-app)) mirrors P1 tokens; its [`globals.css`](../EHB%20landing-2026/content/industries/law/ols-law-source/nextjs-app/src/app/globals.css) defines `--color-ehb-textBody` / `--color-ehb-textMuted` for Tailwind v4 `@theme`.
...
- **DMO UI:** [`/dmo/ehb-stl-level`](../EHB%20landing-2026/app/dmo/ehb-stl-level/page.tsx) (full reference, master plan §7) — includes [`StlMetaJsonPanel`](../EHB%20landing-2026/components/dmo/StlMetaJsonPanel.tsx) to fetch, view, and copy **`GET /api/stl/meta`** JSON · [`/dmo/stl`](../EHB%20landing-2026/app/dmo/stl/page.tsx) (operations: tables, manual calc).
- **User-facing STL chip:** [`ProfileStlBadge`](../EHB%20landing-2026/components/stl/ProfileStlBadge.tsx) on [`/profile`](../EHB%20landing-2026/app/profile/page.tsx) and [`/dashboard`](../EHB%20landing-2026/app/dashboard/page.tsx) — live **`GET /api/stl/me`** (level + score); links to DMO reference when signed in.
- **GoSellr + STL:** [`GET /api/gosellr/trust`](../EHB%20landing-2026/app/api/gosellr/trust/route.ts) returns composite trust plus **`stl`** (`score`, `level`, `label`, `source`: `db` \| `synthetic`). Used on [`GoSellrProductCard`](../EHB%20landing-2026/components/gosellr/GoSellrProductCard.tsx) (below price) and [`GoSellrProductStlLine`](../EHB%20landing-2026/components/gosellr/GoSellrProductStlLine.tsx) on product detail.
