...
| EHB_COLOR_SCHEME_PLAN.md | [FLOW-P1-foundation-ui.md](FLOW-P1-foundation-ui.md) | Draft | Full tables in color plan; **code:** `ehb.textBody` / `textMuted` in [`tailwind.config.ts`](../../EHB%20landing-2026/tailwind.config.ts), rollout on landing + key components |
