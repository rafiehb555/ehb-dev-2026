    ...
    <section className="glass-panel card-hover p-3 sm:p-4 border border-white/10">
      <div className="flex flex-wrap gap-2 items-center justify-between">
        <div className="flex flex-wrap gap-2 items-center">
          ...
          <Link
            href="/dmo"
            className="min-h-touch inline-flex items-center justify-center rounded-full bg-white/5 border border-white/10 px-3 py-1.5 text-[11px] font-semibold text-ehb-textBody hover:bg-white/10 transition-all"
          >
            DMO User Side
          </Link>
          <Link
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-4">
        {[
          ...
          <Link
            key={i.href}
            href={i.href}
            className="min-h-touch inline-flex items-center justify-center rounded-2xl glass-panel border border-white/10 px-3 py-2 text-[11px] text-ehb-textBody hover:bg-white/5 transition-all"
          >
            {i.title}
          </Link>
        ))}
