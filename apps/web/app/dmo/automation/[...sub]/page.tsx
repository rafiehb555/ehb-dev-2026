...
export default function AutomationSubPage() {
      ...
      <header className="relative overflow-hidden rounded-2xl border border-[#7B6EF6]/30 bg-gradient-to-br from-[#13162A] via-[#1A1D33] to-[#13162A] p-6 pt-[22px]">
        ...
        <div className="relative space-y-2">
          <div className="flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.22em]">
            ...
            <Link href="/dmo/automation" className="text-white/40 hover:text-white/70 transition-colors">Automation</Link>
            <span className="text-white/25">/</span>
            <span className="text-[#7B6EF6] truncate">{path}</span>
          </div>
          <h1 className="text-2xl font-bold text-white md:text-3xl">Automation — {path.replace(/-/g, " ")}</h1>
