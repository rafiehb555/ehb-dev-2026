      ...
      <header className="relative overflow-hidden rounded-2xl border border-[#F05858]/30 bg-gradient-to-br from-[#13162A] via-[#1A1D33] to-[#13162A] p-6 pt-[22px]">
        ...
        <div className="relative flex flex-col gap-4">
          <div className="min-w-0 space-y-2">
            ...
            <p className="max-w-2xl text-sm text-white/65">Real-time alerts and notifications.</p>
          </div>
        </div>
      </header>

      <section className="rounded-2xl border border-white/10 bg-[#13162A]/70 p-12 text-center">
        <p className="text-white/65">This sub-section is not yet available. Return to Notifications.</p>
        <Link href="/dmo/notifications" className="mt-4 inline-block rounded-xl border border-[#F05858]/40 bg-[#F05858]/12 px-4 py-2 text-xs font-semibold text-[#F05858] transition-colors hover:border-[#F05858]/70 hover:bg-[#F05858]/20">
