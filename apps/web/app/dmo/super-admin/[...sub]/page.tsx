      ...
      <header className="relative overflow-hidden rounded-2xl border border-[#F05858]/30 bg-gradient-to-br from-[#13162A] via-[#1A1D33] to-[#13162A] p-6 pt-[22px]">
        ...
        <div className="relative space-y-2">
          <div className="flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.22em]">
            ...
            <Link href="/dmo/super-admin" className="text-white/40 hover:text-white/70 transition-colors">Super Admin</Link>
            <span className="text-white/25">/</span>
            <span className="text-[#F05858] truncate">{path}</span>
          </div>
          <h1 className="text-2xl font-bold text-white md:text-3xl capitalize">Super Admin — {path.replace(/-/g, " ")}</h1>
          <p className="max-w-2xl text-sm text-white/65">
            This section is under construction. Return to the main Super Admin panel.
          </p>
        </div>
      </header>
          ...
          <div className="flex justify-center">
            <div className="rounded-full bg-white/5 border border-white/10 p-4">
              <svg viewBox="0 0 24 24" fill="none" className="h-8 w-8 text-white/50">
                <path d="M12 2v20m-9-9h18" stroke="currentColor" strokeWidth="1.6" />
              </svg>
            </div>
          </div>
