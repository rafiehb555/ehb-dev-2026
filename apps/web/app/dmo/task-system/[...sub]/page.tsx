...
export default function TaskSystemSubPage() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#0C0E1A" }}>
      <div className="p-8">
        <SectionHeader title="Task System Sub-Page" subtitle="Task management details" />
        <div
        ...
        >
          <p className="text-gray-400">Task details...</p>
        </div>
      </div>
    </div>
  );
