    ...
    <main className="min-h-screen text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-5 sm:space-y-6 text-[10px] xs:text-[11px]">
        <header className="space-y-1">
          <p className="text-[11px] uppercase tracking-[0.2em] text-white/50">DMO · Master Franchise</p>
          <h1 className="text-lg sm:text-xl font-semibold leading-tight text-white">Master-region monitoring</h1>
          <p className="text-white/70 max-w-2xl">Monitor master-region performance, inspections, and franchise execution quality by operating context.</p>
        </header>

        <DmoTopNav />

        <DmoFranchiseDashboard level="Master" locationLabel={locationLabel} initialIndustrySlug={industry} locationQs={locationQs} />
