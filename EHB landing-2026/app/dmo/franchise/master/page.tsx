    ...
    <main className="min-h-screen text-white">
      <div className="container-ehb py-6 sm:py-8 space-y-5 sm:space-y-6 text-[10px] xs:text-[11px]">
        <header className="space-y-1">
          <p className="text-[11px] uppercase tracking-[0.2em] text-ehb-textMuted">DMO · Master Franchise</p>
          <h1 className="text-lg sm:text-xl font-semibold leading-tight gradient-text">Master-region monitoring</h1>
          <p className="text-ehb-textBody max-w-2xl">Monitor master-region performance, inspections, and franchise execution quality by operating context.</p>
        </header>
