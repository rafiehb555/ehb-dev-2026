...
import { AiDataPipelineAdminPanel } from "@/components/ai/AiDataPipelineAdminPanel";

export default function AdminAiDataPipelinePage() {
  return (
    <main className="min-h-screen text-white">
      <div className="container-ehb py-6 sm:py-8 space-y-5 sm:space-y-6 text-[10px] xs:text-[11px]">
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div className="space-y-1">
            <p className="text-[11px] uppercase tracking-[0.2em] text-ehb-textMuted">Admin Â· Phase 85</p>
            <h1 className="text-lg sm:text-xl font-semibold leading-tight gradient-text">AI Data Pipeline</h1>
            <p className="text-ehb-textBody max-w-2xl">
              Ingestion â†’ storage â†’ scoring â†’ insights publish. (UI mock)
            </p>
          </div>
