  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? "bg-gradient-to-r from-cyan-500/25 to-blue-500/20 text-cyan-100 shadow-inner shadow-cyan-500/10" : "text-slate-400 hover:bg-slate-800/60 hover:text-slate-200",
        className,
      )}
