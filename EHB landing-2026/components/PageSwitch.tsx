...
export function PageSwitch({ industrySlug }: PageSwitchProps) {
  ...
  const activeClass =
    "bg-gradient-to-r from-[#33C3FF] to-[#22b14c] text-slate-950 shadow-[0_0_24px_rgba(34, 177, 76,0.4)] scale-[1.03] border border-white/60";

  const inactiveClass =
    "glass-panel border border-white/15 text-ehb-textBody hover:text-white hover:border-[#33C3FF]/40 hover:shadow-[0_0_16px_rgba(51, 195, 255,0.25)]";
